package com.aurafit.business.user.controller;
...
import com.aurafit.business.user.dto.request.UserStatusUpdateRequest;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<com.aurafit.common.dto.response.PaginatedResponse<UserResponseDTO>>> getAllUsers(
