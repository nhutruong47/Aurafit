  ...
  return (
    <header className="sticky top-0 z-50 flex h-20 w-full items-center justify-between border-b border-[#cfc4c5] bg-[#f9f9f9] px-5 md:px-20">
      <button onClick={() => onNavigate?.('checkout')} className="group flex items-center gap-2">
        ...
        <span className="text-[12px] font-semibold uppercase tracking-[0.15em] text-[#5f5e5e]">Quay lại giỏ hàng</span>
      </button>
      ...
      <div className="hidden items-center gap-3 md:flex">
        ...
        <span className="text-[12px] font-semibold uppercase tracking-[0.15em] text-[#999999]">Thanh toán an toàn</span>
      </div>
    </header>
  );
}
